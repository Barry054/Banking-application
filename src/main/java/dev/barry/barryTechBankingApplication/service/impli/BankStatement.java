...
import dev.barry.barryTechBankingApplication.repository.TransactionRepository;
...
public class BankStatement {
    ...
    private static final String FILE = "C:\\Users\\barri\\OneDrive\\Desktop\\Books\\Books\\MyStatement.pdf";
    ...
    public List<Transaction> generateStatement(String accountNumber, String startDate, String endDate)
        ...
        PdfPCell bankName = new PdfPCell(new Phrase("The Eyaa Tech Academy Bank"));
        bankName.setBorder(0);
        bankName.setBackgroundColor(BaseColor.BLUE);
        bankName.setPadding(20f);

        PdfPCell bankAddress = new PdfPCell(
                new Phrase("16, Sinchu Baliya, Banjul, The Gambia")
        );
